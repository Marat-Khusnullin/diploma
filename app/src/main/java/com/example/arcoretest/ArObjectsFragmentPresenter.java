...
public class ArObjectsFragmentPresenter implements LocationCallbackInterface {
    ...
    public void getLocalWaterObjects() {
        ...
        LocationClassModel locationClassModel = new LocationClassModel(fragment.getContext(), this);
